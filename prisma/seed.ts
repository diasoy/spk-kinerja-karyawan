...
async function main() {
  ...
  // Subkriteria untuk Kecerdasan (KRT04-KRT08)
  ...
  // Subkriteria untuk Kepribadian (KRT09-KRT11)
  ...
  // Note: Sekarang faktor sudah ada di Subkriteria langsung, 
  // ProfileTarget hanya untuk override per periode jika diperlukan
  // ================
  const profileTargetData = [
    // Sikap - semua core factor
    { kode: 'KRT01', nilaiIdeal: 3, faktor: FaktorType.CORE },
    { kode: 'KRT02', nilaiIdeal: 3, faktor: FaktorType.CORE },
    { kode: 'KRT03', nilaiIdeal: 3, faktor: FaktorType.CORE },
    
    // Kecerdasan - mixed
    { kode: 'KRT04', nilaiIdeal: 3, faktor: FaktorType.SECONDARY },
    { kode: 'KRT05', nilaiIdeal: 3, faktor: FaktorType.CORE },
    { kode: 'KRT06', nilaiIdeal: 3, faktor: FaktorType.CORE },
    { kode: 'KRT07', nilaiIdeal: 3, faktor: FaktorType.SECONDARY },
    { kode: 'KRT08', nilaiIdeal: 3, faktor: FaktorType.SECONDARY },
    
    // Kepribadian - mixed
    { kode: 'KRT09', nilaiIdeal: 3, faktor: FaktorType.CORE },
