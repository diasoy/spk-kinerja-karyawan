...
export default function GapPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Tabel 4: Hasil Perhitungan Konversi Nilai Gap */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-3">
            <Calculator className="h-6 w-6 text-purple-600" />
            Hasil Perhitungan Konversi Nilai Gap
          </CardTitle>
          <CardDescription>
            Ringkasan konversi: Nilai Aktual → Gap → Bobot untuk setiap karyawan dan subkriteria
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="overflow-x-auto">
                ...
                <tr className="border-b-2 border-gray-300">
                  ...
                  {Object.entries(groupedSubkriteria).map(([kriteriaKode, { nama, subkriteria }]) => (
                    <th
                      key={kriteriaKode}
                      colSpan={subkriteria.length}
                      className="border-r border-gray-300 px-4 py-2 text-center font-semibold bg-purple-50"
                    >
                      {nama}
                    </th>
                  ))}
                ...
                {penilaianData.map((data, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {subkriteriaList.map((sub) => {
                        const nilai = getNilaiAktual(data.karyawanId, sub.id)
                        const gap = getGap(data.karyawanId, sub.id)
                        const bobot = getBobotGap(data.karyawanId, sub.id)
                        return (
                          <td
                          ...
                          >
                            <div className="flex flex-col items-center gap-1 text-xs">
                              <div className="flex items-center gap-1">
                                ...
                                <span className="font-semibold text-blue-700">{nilai}</span>
                              </div>
                              <div className="flex items-center gap-1">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                <span className="font-semibold text-purple-700">{bobot.toFixed(1)}</span>
                              </div>
                            </div>
                          </td>
                        )
            ...
            <div className="text-sm text-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Gap (Nilai - Standar)</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-medium">B:</span>
                  <span>Bobot dari Tabel Gap-Bobot</span>
                </div>
              </div>
            </div>
          </div>
